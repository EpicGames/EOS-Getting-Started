...
namespace EOSCSharpSample
{
    public class ApplicationSettings
    {
        ...
        // This 64-character hexadecimal string builds a 256-bit key that EOS uses to encrypt user data.
        // Epic's backend servers do not store this key.
        public string EncryptionKey = "1111111111111111111111111111111111111111111111111111111111111111";

        // This is the full path to the local directory that the interface will use for temporary storage during data file transfers.
