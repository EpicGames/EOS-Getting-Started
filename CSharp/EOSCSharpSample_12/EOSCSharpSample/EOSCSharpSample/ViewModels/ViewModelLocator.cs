...
namespace EOSCSharpSample.ViewModels
{
    public static class ViewModelLocator
    {
        ...
        private static LeaderboardsViewModel _leaderboards;
        public static LeaderboardsViewModel Leaderboards
        {
            get { return _leaderboards ??= new LeaderboardsViewModel(); }
        }

        private static AchievementsViewModel _achievements;
        public static AchievementsViewModel Achievements
        {
            get { return _achievements ??= new AchievementsViewModel(); }
        }
        ...
        public static void RaiseConnectCanExecuteChanged()
        {
            ...
            Leaderboards.LeaderboardsQueryDefinitions.RaiseCanExecuteChanged();

            Achievements.AchievementsQueryDefinitions.RaiseCanExecuteChanged();
            Achievements.AchievementsQueryPlayerAchievements.RaiseCanExecuteChanged();
        }
    }
}
