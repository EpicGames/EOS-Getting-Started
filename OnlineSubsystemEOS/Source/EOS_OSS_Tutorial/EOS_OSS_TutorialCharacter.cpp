...
void AEOS_OSS_TutorialCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AEOS_OSS_TutorialCharacter::Move);
...
void AEOS_OSS_TutorialCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
