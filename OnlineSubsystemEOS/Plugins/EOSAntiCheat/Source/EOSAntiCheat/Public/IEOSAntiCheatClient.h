 ...
 *   - PeerToPeer:   full-mesh; plugin owns transport on a dedicated EOS P2P socket.
...
#if P2PMODE
	/** Register/unregister mesh peers. PeerUser is the lobby-participant PUID; EAC runs its own handshake on top. */
